    ...
    <main className="h-screen flex items-center justify-center bg-gradient-to-bl from-cyan-500 from-cyan-600 via-blue-800 to-blue-900">
      <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-blue-950 rounded-3xl">
        <div className="mx-auto w-full max-w-sm lg:w-96">
          <div>
            <h2 className="mt-6 text-3xl font-semibold text-slate-50">Cadastro</h2>
            <div>
              
            </div>
          </div>
          <div className='mb-4'>
            <input type="password" placeholder='NOME' className='apperance-none block w-full py-3 px-4 leading-tight text-gray-700 bg-gray-50 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus: outline-none'/>
          </div>
          <div className='mb-4'>
            <input type="password" placeholder='SOBRENOME' className='apperance-none block w-full py-3 px-4 leading-tight text-gray-700 bg-gray-50 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus: outline-none'/>
          </div>
          <div className='mb-4'>
